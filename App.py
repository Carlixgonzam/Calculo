...
# Funciones de integración (las mismas que en tu código original)
...
<body>
    <h1>Bienvenida, Carla</h1>
    <p>Seleccione la categoría de la integral que desea resolver:</p>
    <form method="post">
        <select name="option">
            <option value="1">Integral con √(a² - x²)</option>
            <option value="2">Integral con √(a² + x²)</option>
            <option value="3">Integral con √(x² - a²)</option>
            <option value="4">Integral con √(a*x² + b*x + c) (completar el cuadrado)</option>
            <option value="5">Integral de función compuesta f(g(x))*g'(x)</option>
            <option value="6">Integral de f'(x)*[f(x)]ⁿ</option>
            <option value="7">Integral con funciones trigonométricas</option>
            <option value="8">Otro caso (integración general)</option>
        </select>
